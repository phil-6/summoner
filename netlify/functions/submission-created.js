...
exports.handler = (event, context, callback) => {
    ...
    if (body.payload.form_name === "summon-form") {
        ...
        You can share your location with them by following this link: https://summoner.purpleriver.dev/share?summoner=${data.summoner}&summoner_num=${data.summoner_phone}&summonee=${data.summonee}`
    }
